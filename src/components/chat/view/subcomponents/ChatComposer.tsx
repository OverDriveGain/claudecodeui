  ...
  return (
    <div className="flex-shrink-0 p-2 pb-2 sm:p-4 sm:pb-4 md:p-4 md:pb-6">
      ...
      {!hasQuestionPanel && <div className="relative mx-auto max-w-4xl">
        ...
        <PromptInputFooter>
          <PromptInputTools>
            {/* BTI: composer stripped to attach-file only — mode toggle, token
                usage, slash-command menu (+badge) and clear-input removed for the
                customer-facing single-conversation UX. */}
            <PromptInputButton
