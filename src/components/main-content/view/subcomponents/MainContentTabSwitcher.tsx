import { MessageSquare, Terminal, Folder, GitBranch, ClipboardCheck, LayoutGrid, type LucideIcon } from 'lucide-react';
...
const BASE_TABS: BuiltInTab[] = [
  ...
  { kind: 'builtin', id: 'canvas', labelKey: 'tabs.canvas', icon: LayoutGrid },
