    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            <span className="text-base font-semibold text-foreground">bldr</span>
            <a
              href={releasesUrl}
              target="_blank"
      ...
      {!IS_PLATFORM && (
        <div className="rounded-xl border border-primary/10 bg-primary/5 p-4">
          <h4 className="text-sm font-medium text-foreground">Try bldr Hosted</h4>
      ...
      {!IS_PLATFORM && (
        <div className="space-y-4 border-t border-border/50 pt-6">
          <h3 className="text-sm font-medium text-foreground">bldr Pro Features</h3>
          <PremiumFeatureCard
