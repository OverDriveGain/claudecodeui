    ...
    >
      ...
      <ScrollArea className="flex-1 overflow-y-auto overscroll-contain md:px-1.5 md:py-2">
        {showConversationSearch ? (
          ...
          /* MYMU: the live-agents tab — its own full list (FORK.md F1). The
             conversations tab renders further down via SidebarConversationsList
             (MyMu 1.37.9) — upstream's SidebarRecentConversations feed (#1041)
             is intentionally NOT wired; ours supersedes it. */
