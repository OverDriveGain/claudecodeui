...
async function resolveDeliveredPath(sessionId, requestedPath) {
    ...
    // OpenCode/Codex agent sessions have none, so never hit the relay with their ids.
    if (sessionId.startsWith('ocs_') || sessionId.startsWith('cxs_')) return { delivered: false, resolved };
